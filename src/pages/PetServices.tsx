import { ArrowLeft, PawPrint, Footprints } from "lucide-react";
import { useNavigate } from "react-router-dom";
import Navbar from "@/components/Navbar";
import { Badge } from "@/components/ui/badge";

const services = [
  { icon: Footprints, label: "Paseo de Mascotas", color: "bg-primary", isActive: false },
  { icon: PawPrint, label: "Peluquería Canina", color: "bg-secondary", isActive: false },
];
