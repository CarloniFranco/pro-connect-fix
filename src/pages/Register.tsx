...
const Register = () => {
  ...
  const handleGoogleRegister = async () => {
    if (!role) {
      toast.error("Primero seleccioná si sos Cliente o Profesional");
      return;
    }
    setLoading(true);
    try {
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-lg md:p-8">
            <div className="mb-6 text-center">
              ...
              <h1 className="font-display text-2xl font-bold text-foreground">
                Creá tu cuenta en FIX
              </h1>
              <p className="mt-1 text-sm text-muted-foreground">
                ¿Cómo querés usar FIX?
              </p>
            </div>
  ...
  // Step 2: Registration form (after role selected)
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <button
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-lg md:p-8">
          <div className="mb-6 text-center">
            ...
            <h1 className="font-display text-2xl font-bold text-foreground">
              Registro como {role === "client" ? "Cliente" : "Profesional"}
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
